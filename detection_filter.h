...
typedef struct controlStruct {
	...
	int nchan_win; // number of subchannels in the window
...
int subband_filter (acfStruct *acfStructure);
...
float calNoise (noiseStruct *noiseStructure, controlStruct *control)
{
	...
	noiseStructure->nchn = control->nchan_win; 
...
float calculateNDynSpec (acfStruct *acfStructure)
{
	...
	int nchan = acfStructure->nchn_win;
...
int winDynSpec (acfStruct *acfStructure, long seed)
{
	...
	int nchn = acfStructure->nchn;
	int nchn_win = acfStructure->nchn_win;
	...
	int j;
	float temp;
	int tempf = (int)(nchn/nchn_win); // number of pixels to average
	...
	{
		printf ("Number of channles too small!\n");
	}
